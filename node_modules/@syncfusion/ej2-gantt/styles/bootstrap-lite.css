...
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar.e-gantt-child-manualtaskbar {
  background: -webkit-gradient(linear, left top, right top, from(rgba(63, 81, 181, 0.2)), color-stop(30%, #7538C9), color-stop(70%, #7538C9), color-stop(70%, #7538C9), to(rgba(63, 81, 181, 0.2)));
...
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar {
  background: -webkit-gradient(linear, left top, right top, from(rgba(49, 122, 185, 0.2)), color-stop(30%, #317ab9), color-stop(70%, #317ab9), color-stop(70%, #317ab9), to(rgba(49, 122, 185, 0.2)));
