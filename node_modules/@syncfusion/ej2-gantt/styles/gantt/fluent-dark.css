...
.e-gantt .e-grid .e-focused:not(.e-menu-item) {
  -webkit-box-shadow: 0 0 0 1px #a19f9d inset !important;
...
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar {
  background: -webkit-gradient(linear, left top, right top, from(#005a9e), color-stop(30%, #0078d4), color-stop(70%, #0078d4), color-stop(70%, #0078d4), to(#005a9e));
