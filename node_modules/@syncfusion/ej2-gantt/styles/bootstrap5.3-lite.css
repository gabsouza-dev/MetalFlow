...
.e-gantt .e-grid .e-focused:not(.e-menu-item) {
  -webkit-box-shadow: 0 0 0 1px var(--color-sf-primary) inset !important;
...
.e-gantt .e-gantt-chart .e-gantt-child-taskbar-inner-div {
  ...
  outline: 1px solid var(--color-sf-primary);
  border-radius: 4px;
}
...
.e-gantt .e-gantt-chart .e-gantt-parent-taskbar-inner-div {
  outline: 1px solid var(--color-sf-border-dark);
}
.e-gantt .e-gantt-chart .e-gantt-parent-taskbar-inner-div {
...
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar.e-gantt-child-manualtaskbar {
  background: -webkit-gradient(linear, left top, right top, from(var(--color-sf-success-light)), color-stop(30%, var(--color-sf-success)), color-stop(70%, var(--color-sf-success)), color-stop(70%, var(--color-sf-success)), to(var(--color-sf-success-light)));
...
.e-gantt .e-gantt-chart .e-event-markers .e-gantt-right-arrow {
  border-right-color: var(--color-sf-warning-light-alt);
  border-left-color: var(--color-sf-warning-light-alt) !important; /* stylelint-disable-line declaration-no-important */
}
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar {
  background: -webkit-gradient(linear, left top, right top, from(var(--color-sf-primary-light)), color-stop(30%, var(--color-sf-primary)), color-stop(70%, var(--color-sf-primary)), color-stop(70%, var(--color-sf-primary)), to(var(--color-sf-primary-light)));
  background: linear-gradient(to right, var(--color-sf-primary-light), var(--color-sf-primary) 30%, var(--color-sf-primary) 70%, var(--color-sf-primary) 70%, var(--color-sf-primary-light) 100%);
  border: 0px;
  border-radius: 4px;
}
...
.e-gantt .e-gantt-chart .e-connectorpoint-left-hover,
.e-gantt .e-gantt-chart .e-connectorpoint-right-hover {
  background-color: var(--color-sf-connector-point-hover-color);
  border-color: var(--color-sf-content-bg-color);
}
.e-gantt .e-gantt-chart .e-connectorpoint-left-hover:hover,
.e-gantt .e-gantt-chart .e-connectorpoint-right-hover:hover {
  background-color: var(--color-sf-icon-color-hover);
  border-color: var(--color-sf-content-bg-color);
}
.e-gantt .e-gantt-chart .e-left-label-inner-div,
.e-gantt .e-gantt-chart .e-right-label-inner-div {
...
.e-gantt .e-menu-item.e-selected .e-icons:not(.e-stop):not(.e-check):not(.e-icon-left):not(.e-date-icon) {
  color: var(--color-sf-flyout-text-color-pressed) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-gantt-dialog .e-tab .e-tab-header .e-toolbar-item.e-active .e-tab-wrap .e-tab-text {
  color: var(--color-sf-content-text-color-alt2) !important; /* stylelint-disable-line declaration-no-important */
}
.e-gantt-dialog .e-tab .e-tab-header .e-toolbar-item .e-tab-wrap {
  border-color: transparent;
}
.e-gantt-dialog .e-tab .e-tab-header .e-toolbar-item .e-tab-wrap .e-tab-text {
  color: var(--color-sf-primary) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-gantt .e-gantt-chart .e-gantt-critical-unscheduled-taskbar {
  background: -webkit-gradient(linear, left top, right top, from(rgba(255, 85, 85, 0.2)), color-stop(30%, var(--color-sf-danger)), color-stop(70%, var(--color-sf-danger)), color-stop(70%, var(--color-sf-danger)), to(rgba(255, 85, 85, 0.2)));
